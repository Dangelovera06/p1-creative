...
export default function DecemberLeadQuiz({ isOpen, onClose }) {
                  ...
                  >
                    ...
                    {currentStepData.id === 'contact' && (
                      <div className="space-y-3">
                        <div className="grid grid-cols-2 gap-3">
                          <div>
                            ...
                            <input
                              ...
                              placeholder="John"
                              className="w-full px-3 py-2.5 bg-white/10 border border-white/20 rounded-lg text-white placeholder:text-white/40 focus:outline-none focus:border-[#006eff] transition-colors text-sm"
                            />
                          </div>
                          <div>
                        ...
                        <div>
                          ...
                          <p className="text-[10px] text-white/50 mb-1">The best email to reach out to in case we need to.</p>
                          <input
                            type="email"
                        ...
                        <div>
                          ...
                          <p className="text-[10px] text-white/50 mb-1">In case it's something urgent, we will send an SMS / Call.</p>
                          <input
                            type="tel"
                        ...
                        {currentStepData.options.map((option, index) => {
                          ...
                          return (
                            <button
                              ...
                              className={`w-full text-left px-4 py-3 rounded-lg border-2 transition-all duration-200 text-sm ${
                                isSelected
                    ...
                    <div className="flex justify-between items-center mt-6 pt-4 border-t border-white/10">
                      ...
                      <button
                        ...
                        className={`px-5 py-2.5 rounded-lg font-semibold flex items-center gap-2 transition-all text-sm ${
